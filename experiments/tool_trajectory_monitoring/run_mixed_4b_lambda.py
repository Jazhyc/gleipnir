#!/usr/bin/env python3
"""Preflight and train the mixed-data Qwen3.5-4B adapter on Lambda."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=(
            DEFAULT_SCALING_RESULT_DIR
            / "selections"
            / "preflight-longest-32.jsonl"
        ),
    )
...
def main() -> None:
    ...
    jobs = relocate_jobs(
        ...
        result_dir,
        validator=validate_mixed_4b_jobs,
    )
    ...
    try:
        ...
        preflight_job = {
            **full_job,
            "job_name": "preflight-mixed-qwen35-4b-r128-longest32",
