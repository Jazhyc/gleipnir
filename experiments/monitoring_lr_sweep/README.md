...
QLoRA, microbatch 8 with gradient accumulation 4, and Kimi K3 soft-target BCE at
...
microbatch-8 longest-sequence preflight, trains two serial lanes in parallel,
