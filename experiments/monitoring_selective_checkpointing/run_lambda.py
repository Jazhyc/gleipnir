#!/usr/bin/env python3
"""Preflight and benchmark selective checkpointing on one Lambda H100."""
...
from experiments.monitoring_selective_checkpointing.core import (  # noqa: E402
    JOB_NAME,
    validate_jobs,
...
def main() -> None:
    ...
    try:
        ...
        validate_training_metadata(
            json.loads(candidate.read_text()), expected_steps=20
        )
        ...
        subprocess.run(
            [
                sys.executable,
                "-m",
                "experiments.monitoring_selective_checkpointing.summarize",
                "--baseline",
