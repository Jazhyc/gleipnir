#!/usr/bin/env python3
"""Preflight then run the matched inner-mixer compile screen on two H100s."""
...
from experiments.monitoring_inner_mixer_compile.core import (  # noqa: E402
    CANDIDATE_NAME,
    CANDIDATE_POLICY,
    OPTIMIZER_STEPS,
    validate_jobs,
    ...
    try:
        ...
        preflight = {
            **candidate,
            ...
            "design_role": "longest_trajectory_inner_mixer_compile_preflight",
            "train_rows": 32,
            "max_steps": 1,
        ...
        subprocess.run(
            [
                sys.executable,
                "-m",
                "experiments.monitoring_inner_mixer_compile.summarize",
                "--jobs",
                jobs_path.as_posix(),
                "--output",
